            ...
            <div className="inline-block align-bottom bg-white rounded-3xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="mt-4">
                    <p className=" ">
                      Ten en cuenta que una vez se elimine al colaborador, este
                      ya no podrá acceder al proyecto.
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  type="button"
                  className="w-full inline-flex py-2 px-4 rounded-3xl text-sm border text-white hover:cursor-pointer bg-red-600 hover:bg-red-800 gap-2 items-center justify-center sm:ml-3 sm:w-auto sm:text-sm"
                >
                  Eliminar
                </button>
                <button
                  onClick={handleDeleteCollaboratorModal}
                  type="button"
                  className="w-full inline-flex py-2 px-4 rounded-3xl text-sm border text-black hover:cursor-pointer bg-white hover:bg-gray-100 gap-2 items-center justify-center sm:ml-3 sm:w-auto sm:text-sm"
                >
                  {' '}
                  Cancelar
                </button>
